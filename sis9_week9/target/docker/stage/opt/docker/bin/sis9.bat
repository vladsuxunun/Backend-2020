@REM sis9 launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM SIS9_config.txt found in the SIS9_HOME.
...
set "CFG_FILE=%APP_HOME%\SIS9_config.txt"
set CFG_OPTS=
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running sis9.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !SIS9_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
